...
public class AdminPanelGUI extends AbstractGUI {
    ...
    public void initItems() {
        gui.setItem(20, new GuiItem(ItemBuilder.create(WrappedMaterials.LIME_WOOL).display("§aBuilder Statistics").lore("§7See the stats of builders", "", "§eClick here to open the panel!").build()));
        gui.setItem(24, new GuiItem(ItemBuilder.create(WrappedMaterials.YELLOW_WOOL).display("§aTickets Statistics").lore("§7See the stats of the tickets", "", "§eClick here to open the panel!").build()));
